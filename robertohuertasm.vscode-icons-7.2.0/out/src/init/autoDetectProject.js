...
function applyDetection(message, presetText, value, initValue, defaultValue, autoReload, updatePreset, applyCustomization, reload, cancel, showCustomizationMessage) {
    return updatePreset(presetText, value, defaultValue, false)
        ...
        showCustomizationMessage(message, [{ title: messages_1.messages.reload }, { title: messages_1.messages.autoReload }, { title: messages_1.messages.disableDetect }], applyCustomization, cancel, presetText, !value, initValue, false);
    });
}
