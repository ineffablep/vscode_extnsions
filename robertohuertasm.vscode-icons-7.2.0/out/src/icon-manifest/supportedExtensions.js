...
exports.extensions = {
    ...
    supported: [
        ...
        { icon: 'ng_controller_ts', extensions: ['controller.ts'], format: models_1.FileFormat.svg },
        { icon: 'ng_controller_js', extensions: ['controller.js'], format: models_1.FileFormat.svg },
        ...
        { icon: 'binary', extensions: ['a', 'app', 'bin', 'cmo', 'cmx', 'cma', 'cmxa', 'cmi', 'dll', 'exe', 'hl', 'lib', 'n', 'ndll', 'o', 'obj', 'pyc', 'pyd', 'pyo', 'pdb', 'scpt', 'scptd', 'so'], format: models_1.FileFormat.svg },
        ...
        { icon: 'drone', extensions: ['.drone.yml'], light: true, filename: true, format: models_1.FileFormat.svg },
        ...
        { icon: 'terraform', extensions: [], languages: [languages_1.languages.terraform], format: models_1.FileFormat.svg },
