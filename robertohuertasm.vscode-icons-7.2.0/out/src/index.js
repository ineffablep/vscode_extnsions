        ...
        if (results != null && results.length) {
            ...
            if (isInRootFolder) {
                ...
                if (toggle.apply) {
                    ...
                    init_1.applyDetection(toggle.message, presetText, toggle.value, initValue, defaultValue, config.projectDetection.autoReload, commands_1.updatePreset, commands_1.applyCustomization, commands_1.reload, commands_1.cancel, commands_1.showCustomizationMessage);
                }
                return;
            }
        }
