                ...
                if (settings.version == 0 || settings.version < environmentPath_1.Environment.CURRENT_VERSION) {
                    ...
                    if (done == true) {
                        if (oldSettingVersion == 0) {
                            ...
                            vscode.window.showInformationMessage("Sync : Now you can exclude any file / folder for upload and settings for download.", "Open Tutorial").then(function (val) {
                            ...
                            vscode.window.showInformationMessage("Sync : Local Settings Layout has been changed. Old file is deleted. Open Tutorial for new Layout.", "Open Tutorial").then(function (val) {
                                if (val == "Open Tutorial") {
                                    openurl("http://shanalikhan.github.io/2017/02/19/Option-to-ignore-settings-folders-code-settings-sync.html");
                                }
                            });
